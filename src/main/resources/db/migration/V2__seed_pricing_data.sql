...
-- ==========================================================================================
-- TBL_FARE_TAX — 세금/할증 마스터 (4종)
-- ==========================================================================================

-- ① 출국납부금 (KR) — 정액 10,000원, 기간 무제한
INSERT INTO TBL_FARE_TAX
...
-- ==========================================================================================
-- TBL_FARE_TAX_MAPNG — 운임-세금 매핑 (17건)
-- 일본 노선(NRT): 출국납부금(1) → 유류할증(2) → 일본소비세(3, TOTAL기준)
-- 기타 노선:      출국납부금(1) → 유류할증(2)
-- ==========================================================================================

-- FARE001: KE ICN→NRT 비성수기 (YQ=FTAX002, 15%)
INSERT INTO TBL_FARE_TAX_MAPNG (FARE_TAX_MAPNG_ID, FARE_ID, FARE_TAX_ID, APLCN_ORD, REG_DT, RGTR_ID)
